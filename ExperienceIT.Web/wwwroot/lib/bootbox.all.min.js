/**
 * bootbox.js 5.5.2
 *1) Direct download from Production, with locales http://bootboxjs.com/getting-started.html
 * add the bootbox.all.min.js under lib folder
 * 2)Add the script tag reference in layout.cshtml
 * 3) Use bootbox in events index html javascript
